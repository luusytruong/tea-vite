        ...
        {cartItems.length > 0 ? (
          <div className="lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden mb-6">
              ...
              <motion.div
                className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300 p-6 mb-6 lg:mb-0 space-y-4"
            ...
            <div className="lg:col-span-1">
              <motion.div
                className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden sticky top-[132px]"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300 p-12 text-center max-w-2xl mx-auto"
